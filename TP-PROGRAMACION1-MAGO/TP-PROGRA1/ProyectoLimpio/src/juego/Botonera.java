...
public class Botonera {
	...
	public Botonera(double x, double y) {
		...
		this.explosion1 = Herramientas.cargarImagen("Imagenes TP Programacion 1/Explosion 1 (fuego).gif").getScaledInstance(500, 500, 0);
		this.explosion2 = Herramientas.cargarImagen("Imagenes TP Programacion 1/Explosion 2 (Agua).gif").getScaledInstance(750, 750, 0);
		this.explosion3 = Herramientas.cargarImagen("Imagenes TP Programacion 1/Explosion 3 (Veneno).gif").getScaledInstance(1000, 1000, 0);
	}
